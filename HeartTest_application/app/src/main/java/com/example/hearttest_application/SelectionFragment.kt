...
class SelectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_back.setOnClickLister(this)
        option_1.setOnClickLister(this)
        option_2.setOnClickLister(this)
        option_3.setOnClickLister(this)
        option_4.setOnClickLister(this)
    }
